...
const Past_moves = ({ user }) => {
    ...
    const residentCard = sortByDate.map((c) => {
        ...
        const badColorPercentage = percentageNoDecimal < 30 ? <td class="whitespace-nowrap font-bold pb-4 px-4 text-red-600">{percentageNoDecimal}%</td> : <td class="whitespace-nowrap font-bold pb-4 px-4 text-orange-400">{percentageNoDecimal}%</td>

        const colorPercentage = percentageNoDecimal < 100 ? badColorPercentage : <td class="whitespace-nowrap font-bold pb-4 px-4 text-green-600">{percentageNoDecimal}%</td>
                ...
                <div class="w-3/4 m-auto">
                    <div class="rounded-lg mt-8 bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                        ...
                        <div action="" class="space-y-4">
                            ...
                            <button class="px-8 py-3 mt-4 font-bold bg-red-500 text-3xl text-white hover:bg-red-400 rounded-lg" onClick={() => handleMovedIn(c.id)}><h1>Change Back to Future Move-in</h1></button>
            ...
            <div class="overflow-x-auto border-2 rounded-xl">
                <table class="min-w-full divide-y-2 divide-gray-200 text-sm">
                    <tbody class=" divide-y divide-gray-200">
                        <tr class="grid grid-cols-5 pt-8 text-xl pb-2">
    ...
    return (
        <section class="mb-8 mt-8">
            <div class="w-3/4 m-auto">
                <h1 class="text-black text-5xl font-bold">Past Move-in's</h1>


                {/* <div class="relative w-1/2 m-auto mt-4">
                    <input
                        type="search"
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y-2 divide-gray-200 text-sm">
                            <tbody class="border-b-4 border-black">
                                <tr class="grid grid-cols-5 text-2xl font-bold">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">% Complete</td>
