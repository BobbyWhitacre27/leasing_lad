...
const Past_moves = ({ user, setNumberFutureResidents, setNumberPastResidents, setIsLoading }) => {

    // useStates

    const [resident_cards, setResident_Cards] = useState([]);
    const [resident_cardsByUserId, setResident_CardsByUserId] = useState([]);
    ...
    const cardsByUserId = async () => {
		setIsLoading(true)
        const cards = await getResidentCardsByUserId(userId);
		setIsLoading(false)
        setResident_CardsByUserId(cards)
    }
    ...
    const sortByDate = movedInFilter.sort((a, b) => new Date(b.move_in_date) - new Date(a.move_in_date))


    // Resident Card Function
    ...
    const residentCard = sortByDate.map((c) => {
        ...
        const badColorPercentage = percentageNoDecimal < 30 ? <td class="whitespace-nowrap hidden lg:block font-bold pb-4 px-4 text-red-600">{percentageNoDecimal}%</td> : <td class="whitespace-nowrap font-bold pb-4 px-4 hidden lg:block text-orange-400">{percentageNoDecimal}%</td>
                    ...
                    <div class="rounded-lg mt-8 bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                        <div class="flexn">
                            <div>
                                ...
                                <h1 class="flex text-black text-md font-bold">Moved-in: {newDate}</h1>
                        ...
                        <div action="" class="space-y-4">
                            ...
                            <button
                                ...
                                class="inline-block w-full rounded-lg bg-black px-5 py-3 font-medium text-white sm:w-auto mb-2"
                            ...
                            <button
                                ...
                                class="inline-block w-full rounded-lg border-black border-2 bg-white px-4 py-3 font-medium text-black sm:w-auto mb-2"
                            ...
                            <button class="px-8 py-3 mt-4 text-md font-bold bg-red-500 sm:text-3xl text-white hover:bg-red-400 rounded-lg" onClick={() => handleMovedIn(c.id)}><h1>Change Back to Future Move-in</h1></button>
            ...
            <div class="overflow-x-auto border-2 rounded-xl">
                <table class="min-w-full divide-y-2 divide-gray-200 text-sm">
                    <tbody class=" divide-y divide-gray-200">
                        ...
                        <tr class="grid pt-6 lg:grid-cols-4 text-2xl grid-cols-3 text-xl pb-2">
    ...
    return (
        <section class="mb-24 mt-8">
            <div class="sm:w-3/4 m-auto">
                ...
                <div class="m-auto  w-3/4 sm:w-1/2 mt-4">
                    <input
                        type="search"
                ...
                <div class="mt-8">
                    ...
                    {movedInFilter.length >= 1 ? residentCard : <div class="mt-8 font-bold">None at this time.</div>}
                </div>
