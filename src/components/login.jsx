    ...
    return (
        <section>
                    ...
                    <div>
                        ...
                        <video src={leasingLad_video} autoPlay loop muted class="absolute content-center brightness-50" />
                    

                    {/* content */}
                        <div class="relative">
                            <div>
                            <h1 class="text-2xl font-bold sm:text-3xl text-white">Leasing Lad.</h1>
                            <p class="mt-4 text-gray-500 text-white">
